...
const Recipes = () => {
  ...
  return (
    <>
      <div className='min-h-screen pt-20 flex items-center flex-col pb-20 md:px-14 px-10'>
...

        {
          loading ? <div className='mt-10'> <Loader /> </div> :
            ...
            <>
              <h1 className="md:text-5xl text-4xl font-bold text-orange-500 text-center mb-10">Recipes</h1>
                      ...
                      <Link to={`/recipe/${recipe._id}`} key={recipe._id} >
                        ...
                        <div className="bg-gray-100 rounded-lg p-4 flex md:flex-row flex-col gap-5 shadow-md">
                          <div className='md:w-1/4 w-full'>
                            <img src={recipe.recipeImage.url} className="w-96 rounded-md h-32" alt="" />
                          </div>
